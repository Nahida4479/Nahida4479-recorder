...
btn_file = ctk.CTkButton(
    menu_container, text="File", width=65, height=28,
    fg_color="#333333",        
    hover_color="#444444", 
...
btn_edit = ctk.CTkButton(
    menu_container, text="Edit", width=65, height=28,
    fg_color="#333333",        
    hover_color="#444444",
    text_color="#FFFFFF", font=ctk.CTkFont(family="Segoe UI", size=13, weight="bold"),
    corner_radius=6
...
loop_switch = ctk.CTkSwitch(
    ...
    progress_color=LOOP_ON_COLOR,
    button_color="#FFFFFF",
    button_hover_color="#DDDDDD",
    fg_color="#555555",
    width=46, height=22,
    switch_width=46, switch_height=22,
)
loop_switch.select()
...
loop_lbl = ctk.CTkLabel(
    ...
    text_color="#FFFFFF" # Czysta biel sprawia, że jest wyraźniejszy
)
loop_lbl.pack()
...
log_box.pack(fill="x", padx=25, pady=(0, 10))

for line in ["[12:40:01] Click at 400, 500",
             "[12:40:05] Key 'A' pressed",
             "[12:40:05] Key 'A' pressed"]:
...
toast_label = ctk.CTkLabel(
    app, text="Saved 150 events to file.",
    font=ctk.CTkFont(family="Segoe UI", size=12),
    text_color="#FFFFFF",
    fg_color=TOAST_BG,
    corner_radius=8,
